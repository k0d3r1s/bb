...
core app, CLI/SDK, all 35 repository plugins, native clients and hosted services.
...
| [Machines, daemon lifecycle, and updates](hosts-updates.md)                        | 10      | 2 passed, 6 partial/blocked, 2 not run |
...
| [BB CLI guide](plugin-bb-guide.md)                                                  | 4       | 4 not run                             |
| [Browser automation](plugin-browser-automation.md)                                  | 4       | 4 not run                             |
...
| [Manually dispatched drafts](plugin-drafts.md)                                      | 4       | 4 not run                             |
| [Git worktree environment provider](plugin-environment-git-worktree.md)             | 3       | 3 not run                             |
| [Modal sandbox environments](plugin-environment-modal-sandbox.md)                   | 8       | 8 not run                             |
| [Personal workspace environment provider](plugin-environment-personal-workspace.md) | 3       | 3 not run                             |
| [Project checkout environment provider](plugin-environment-project-checkout.md)     | 3       | 3 not run                             |
